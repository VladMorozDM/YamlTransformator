...
namespace YamlTransformer
{
    public class GameObject
    {
        ...
        public GameObject(int mObjectHideFlags, FieldId mCorrespondingSourceObject, FieldId mPrefabInstance, FieldId mPrefabAsset, int serializedVersion, string mName, FieldId mComponent)
        {
